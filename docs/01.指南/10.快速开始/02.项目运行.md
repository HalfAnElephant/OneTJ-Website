...
- `lib/models/data/school_calendar_net_data.g.dart`
- `lib/models/data/course_schedule_net_data.g.dart`
- `lib/models/data/undergraduate_score_net_data.g.dart`
- `lib/models/data/cet_score_net_data.g.dart`
- `lib/models/data/student_exam_net_data.g.dart`
...
编译鸿蒙版本需先安装鸿蒙 Command Line Tools 并配置 PATH（详见「环境准备」）。构建命令与鸿蒙 Flutter SDK 版本相关，具体请以当前 SDK 文档或项目维护者说明为准。
